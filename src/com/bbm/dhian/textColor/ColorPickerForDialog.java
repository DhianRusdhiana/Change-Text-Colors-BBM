...
public class ColorPickerForDialog 
extends 
Dialog 
implements
...
View.OnClickListener {
	...
	public ColorPickerForDialog(Context context, int initialColor) {
		super(context);
	...
	public int getID(String name, String Type) {
		...
		builder.setTitle(getID("reload_title","string"));
		builder.setMessage(getID("reload_msg","string"));
