...
public class SpanFixTextView extends TextView
{
	TextView rl;
	public static SharedPreferences settings;
	public SpanFixTextView(Context context,AttributeSet c) {
		super(context,c);
	...
	public SpanFixTextView(Context context) {
		super(context);
		settings = PreferenceManager.getDefaultSharedPreferences(getContext());
		if(getId() == getID("update_title","id")){
			rl = (TextView) findViewById(getID("update_title","id"));
	...
	public SpanFixTextView(Context context,AttributeSet c,int i) {
		super(context,c,i);
		settings = PreferenceManager.getDefaultSharedPreferences(getContext());
		if(getId() == getID("message_body","id")){
			rl = (TextView) findViewById(getID("message_body","id"));
