...
public class ColoringTextView extends CustomFontTextView
{
	TextView rl;
	public static SharedPreferences settings;
		public ColoringTextView(Context context,AttributeSet c) {
		super(context,c);
		...
		if(getId() == getID("message_sender","id")){
			...
			if(getId() == getID("contact_name","id")){
			    rl = (TextView) findViewById(getID("contact_name","id"));
				Navisha.SetListContactsTitleColor(context,rl);
			}
			if(getId() == getID("contact_message","id")){
			    rl = (TextView) findViewById(getID("contact_message","id"));
			...
			public ColoringTextView(Context context,AttributeSet c,int i) {
	        	super(context,c,i);
				settings = PreferenceManager.getDefaultSharedPreferences(getContext());
				if(getId() == getID("message_body","id")){
					rl = (TextView) findViewById(getID("message_body","id"));
